...
//     solarSystem.push({})
//     solarSystem[8].name ="Pluto"
//     solarSystem[8].ringSystem = false
//     solarSystem[8].moons =["Charon"]
...
//  const sumOfSet = (planetOne, planetTwo, planetThree, planetFour) => {
//     return parseInt(planetOne) + parseInt(planetTwo) + parseInt(planetThree) +parseInt (planetFour)
//  }
//  console.log(sumOfSet(system.jupiter.satellites, system.saturn.satellites, system.uranus.satellites, system.neptune.satellites))
...
let momJupiter = system.jupiter.velocity * system.jupiter.mass
let momPluto = system.pluto.velocity * system.pluto.mass

//console.log(momJupiter, momPluto)
